...
export async function upsertTelegramIdentity(payload = {}, executor = query) {
  ...
  const nextProfile = {
    ...
    launchCount: Number(existing?.launchCount || 0) + (payload.incrementLaunch ? 1 : 0),
  ...
  const updateSql = `
        ...
        set
          ...
          launch_count = $21,
          session_count = $22,
          active_days_count = $23,
          last_active_day = $24::date,
          last_activity_at = $25::timestamptz,
          last_activity_kind = $26,
          retention_state = $27,
          metadata = $28::jsonb,
          updated_at = now()
        where id = $1
  ...
  const insertSql = `
        ...
        values (
          ...
          $21, $22, $23, $24::date, $25::timestamptz, $26, $27, $28::jsonb
        )
        returning *
      `;
