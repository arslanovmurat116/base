    ...
    metrics: [
      {
        ...
        note: "Telegram identities captured in the BOSE launch layer."
      },
      {
        label: "Daily Users",
        value: String(summaries.statistics.dailyUsers),
        note: "People active in the last 24 hours."
      },
      {
        label: "Sessions",
      ...
      },
      {
        ...
        note: "New Telegram identities seen during the last day."
      },
      {
        label: "Clients",
        value: String(summaries.statistics.clientsTotal),
        note: "Client records already linked to BOSE core."
      },
      {
        label: "Deals",
        value: String(summaries.statistics.dealsTotal),
        note: "Core deals available in the workspace."
      },
      {
        label: "Tasks",
      ...
      {
        label: "Appointments",
        value: String(summaries.statistics.appointmentsScheduled),
        note: "Scheduled visits, measurements, or consultations."
      },
      {
        label: "Analytics",
        value: String(summaries.statistics.analyticsEventsTotal),
        note: "Tracked Telegram and Mini App launch events."
      }
    ],
...
export async function getLaunchDebugData() {
  const [health, dashboard, telegramStatus] = await Promise.all([
    checkDatabaseHealth(),
